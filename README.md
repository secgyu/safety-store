...
![진단 페이지](docs/screenshots/diagnose.png)

![진단 플로우](docs/gifs/diagnose-flow.gif)
...
![진단 결과](docs/gifs/results-full.gif)

- 종합 위험도 점수 (게이지 차트)
- 매출/고객/시장 3개 영역 상세 분석
- 레이더 차트 시각화
- 시계열 트렌드 분석
- 업종 벤치마크 비교
- 맞춤형 개선 추천
...
![통계](docs/screenshots/statistics.png)
