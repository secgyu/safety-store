                ...
                <div className="flex-1 space-y-4 w-full">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="bg-muted/50 rounded-lg p-4">
                      ...
                      <p
                        className={`text-2xl font-bold ${latestDiagnosis.salesChange >= 0 ? "text-success" : "text-danger"}`}
                      >
                    ...
                    <div className="bg-muted/50 rounded-lg p-4">
                      ...
                      <p
                        className={`text-2xl font-bold ${latestDiagnosis.customerChange >= 0 ? "text-success" : "text-danger"}`}
                      >
