import { ArrowRight, BarChart3, CheckCircle2, Clock, TrendingUp, Users } from "lucide-react";
      ...
      <section className="container mx-auto px-4 py-20 md:py-32">
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-block mb-4 px-4 py-2 bg-primary/10 rounded-full">
            <span className="text-sm font-semibold text-primary">서울 성동구 영세·중소 가맹점 전용</span>
          </div>
          ...
          <p className="text-xl md:text-2xl text-muted-foreground mb-6 text-pretty leading-relaxed">
            성동구 지역 매출과 고객 데이터로 폐업 위험을 미리 알아보세요
          </p>
          ...
          <div className="mt-16 flex items-center justify-center gap-2 text-muted-foreground">
            ...
            <span className="text-sm">성동구 300+ 가맹점이 사용중</span>
          </div>
        </div>
      </section>
      ...
      <section className="container mx-auto px-4 py-20">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-center text-muted-foreground mb-16 text-xl max-w-2xl mx-auto leading-relaxed">
            간단한 3단계로 성동구 우리 가게의 건강 상태를 확인하세요
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <Card className="glass-card glass-hover rounded-3xl">
              <CardContent className="pt-10 pb-10 text-center">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  성동구 수백 개 가맹점 데이터를 학습한 AI가 우리 가게의 위험도를 정확하게 예측합니다.
                </p>
              </CardContent>
            </Card>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
                매출 추세, 고객 변화, 성동구 지역 시장 상황을 종합적으로 분석하여 4단계 위험도로 표시합니다.
              </p>
          ...
          <div className="space-y-6">
            ...
            <Card className="glass-card rounded-2xl">
              <CardContent className="pt-8 pb-8">
                ...
                <p className="text-muted-foreground leading-relaxed text-lg">
                  성동구 실제 가맹점 데이터를 학습한 AI 모델을 사용합니다. 지역 특성을 반영한 맞춤형 분석을 제공합니다.
                </p>
              </CardContent>
            </Card>
